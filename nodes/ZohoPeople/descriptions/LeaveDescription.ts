	...
	// ========================================
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Employee identifier: "all", Email ID, Employee ID (e.g., DCM239), or Erec No (e.g., 29217000003875017)',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				placeholder: '["DCM239","29217000003875017"]',
				description: 'JSON Array of employee identifiers (Email ID, Employee ID, or Erec No). Example: ["DCM239","29217000003875017"]',
			},
			{
